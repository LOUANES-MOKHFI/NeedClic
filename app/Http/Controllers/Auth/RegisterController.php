    ...
    */
    ...
    public function register(Request $request)
    {
        ...
        return $this->registered($request, $user)
                        ?: redirect('/login')->with('success',"Votre compte a bien étè crée,veuillez attendez que l'administrateur accepte votre demande");
        }
        else{
             return $this->registered($request, $user)
                        ?: redirect('/login')->with('success',"Votre compte a bien étè crée,veuillez");
        }
    }
