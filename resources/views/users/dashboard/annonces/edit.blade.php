                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('users.annonces')}}"> {{__('admin/annonces.all_annonces')}}  </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="box-content">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('users.annonces.update',$annonce->uuid)}}"
                                              method="POST"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="category_id">
                                                                @isset($categoriesPart)
                                                                    @foreach($categoriesPart as $category)
                                                            ...
                                                            <ul class="list-inline">
                                                                <li>
                                                                    <div class="radio info">
                                                                        <input type="radio" @if($annonce->is_negociable == 1) checked @endif value="1" name="is_negociable" id="radio-10"><label for="radio-10">{{__('admin/annonces.negociable')}}</label>
                                                                    </div>
                                                                    <!-- /.radio -->
                                                                </li>
                                                                <li>
                                                                    <div class="radio pink">
                                                                        <input type="radio" @if($annonce->is_negociable == 0) checked @endif value="0" name="is_negociable" id="radio-11"><label for="radio-11">{{__('admin/annonces.notNegociable')}}</label>
                                                                    </div>
                                                                    <!-- /.radio -->
                                                                </li>
                                                            </ul>
