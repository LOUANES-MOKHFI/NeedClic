...
<div class="modal fade" id="filter_ing" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
 aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="advanced_search" action="{{route('comptes.filtre.ingenieur')}}" class="clearfix row" name="advanced_search" method="get">
                    @csrf
                    @isset($category)
