            ...
            <div class="container">
                ...
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        <li> {{__('users/auth.boutique')}}</li>
                    </ul>
                    <h2> {{__('users/auth.boutique')}}</h2>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div id="content" class="col-md-12 col-md-offset clearfix">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">   
                            <div class="widget clearfix">
                                <div class="title">
                                    <h3> {{__('users/auth.boutique')}}</h3>
                                </div>
                                <form  method="POST" action="{{ route('register') }}" enctype='multipart/form-data'>
                                    @csrf
                                    <input type="hidden" name="type_compte" value="3">
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-map-marker"></i></span>
                                                    <input id="adress" type="text" class="form-control @error('adress') is-invalid @enderror" name="adress" value="{{ old('adress') }}"  autocomplete="adress" placeholder=" {{__('users/auth.adress')}}">
                                                </div>
                                                @error('adress')
                                                        <span class="text-danger"> {{$message}}  </span>
                                                    @enderror
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <ul class="list-inline">
                                                @if(count(AbonnementBoutique()) > 0)
                                                @foreach(AbonnementBoutique() as $abonnement)
                                                <li>
