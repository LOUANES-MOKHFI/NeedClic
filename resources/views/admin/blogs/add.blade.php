                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('admin/blogs.add_blog')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="box-content">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{__('admin/blogs.add_blog')}} </h4>
                                </div>
                                        ...
                                        <form class="form" action="{{route('admin.blogs.store')}}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <span style="color: red;font-size: 13px">* {{__('admin/blogs.file')}} jpeg,jpg,png</span> <br>
                                                            <label for="projectinput1">Images</label>
                                                            <input type="file" id="input-file-now" class="" name="attachments[]" accept=",.jpg, .png, image/jpeg, image/png" multiple />
                                                            @error("image")
                                                                <span class="text-danger"> {{$message}}  </span>
                                                            @enderror
                                                        </div>
