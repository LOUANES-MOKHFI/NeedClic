...
@section('title')
{{__('admin/abonnements.edit_abonnement')}}
@endsection
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('admin/abonnements.edit_abonnement')}} - {{$abonnement->type_compte.' - '. $abonnement->duree}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="box-content">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{__('admin/abonnements.edit_abonnement')}} </h4>
                                </div>
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.settings.abonnements.update',$abonnement->id)}}"
                                              method="POST"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="type_compte">
                                                                <option value="Boutique" @if($abonnement->type_compte == "Boutique") selected @endif>Boutique</option>

                                                                <option value="Proffessionnelle" @if($abonnement->type_compte == "Proffessionnelle") selected @endif>Proffessionnelle</option>
                                                            </select>
                                                            @error("type_compte")
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$abonnement->duree}}" id="type"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$abonnement->montant}}" id="type"
