                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('admin/admins.edit_admin')}} - {{$admin->name}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="box-content">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">  {{__('admin/admins.edit_admin')}} </h4>
                                </div>
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i>{{__('admin/admins.admin_information')}} </h4>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="email" id="abbr" class="form-control" placeholder="  " value="{{$admin->email}}" name="email">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="password" id="abbr" class="form-control" placeholder="  "value="" name="password">
