...
@section('title')
{{__('admin/publicite.edit_publicite')}}
@endsection
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('admin/publicite.edit_publicite')}} -  {{$publicite->name}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="box-content">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{__('admin/publicite.edit_publicite')}} </h4>
                                </div>
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.publicite.update',$publicite->id)}}"
                                              method="POST"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$publicite->title}}" id="type"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="description"> {{$publicite->description}}</textarea>
                                                            @error("description")
                                                            <span class="text-danger"> {{$message}}  </span>
                                                            @enderror
                                                        </div>
