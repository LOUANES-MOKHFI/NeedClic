<div class="modal fade" id="delete_archived_affaire" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
 aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.affaires.archived.delete') }}" method="post" >
                    {{ csrf_field() }}
